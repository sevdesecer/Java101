...
public class Arrays7Main {
    public static void main(String[] args) {
        ...
        //Subjects.Arrays.toString()
        System.out.println(Arrays.toString(list));
        System.out.println(Arrays.toString(list2));
        System.out.println();

        //Subjects.Arrays.fill()
        Arrays.fill(list,22);
        System.out.println(Arrays.toString(list));
        ...
        //Subjects.Arrays.sort()
        int[] list3 = {4,56,23,48,66,98,89,-857,-2,0,62};
        Arrays.sort(list3);
        System.out.println(Arrays.toString(list3));
        System.out.println();

        //Subjects.Arrays.binarySearch()
        ...
        // Subjects.Arrays.copyOf() and Subjects.Arrays.copyOfRange() methods
