...
public class Driger extends Beyblade { // Rei Kon

    private String holyBeast;

    public Driger(String beyblader, int rotationSpeed, int attackPower, String holyBeast) {
    ...
    public void holyBeastAppears(){
        ...
        System.out.println(getAttackPower() + "'s attack is : Tiger Claw.");
    }
}
